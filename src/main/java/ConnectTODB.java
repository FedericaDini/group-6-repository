...
class ConnectToDB {
    ...
    public void go() {
        ...
        ConnectionString uri = new ConnectionString("mongodb://localhost:27017/?readPreference=primary&appname=MongoDB%20Compass&ssl=false");
        MongoClient mongo = MongoClients.create(uri);


        // Accessing the database
        MongoDatabase database = mongo.getDatabase("Prova");
        MongoCollection<Document> collection = database.getCollection("troncare");
